...
export default function ReagendamentoSolicitadoCliente({ onClose, onConcluir }) {
            ...
            <div style={{ padding: 20 }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <select
                  ...
                  style={{ width: "100%", padding: "10px 12px", border: "1px solid #E5E7EB", borderRadius: 8, fontSize: 14, color: motivo ? "#374151" : "#9CA3AF", outline: "none", background: "#fff" }}
                >
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <textarea
                  ...
                  style={{ width: "100%", boxSizing: "border-box", padding: "10px 12px", border: "1px solid #E5E7EB", borderRadius: 8, fontSize: 14, color: "#374151", outline: "none", resize: "none" }}
                />
                <div style={{ textAlign: "right", fontSize: 12, color: "#9CA3AF" }}>{observacao.length}/200</div>
              </div>

              <div style={{ display: "flex", gap: 12 }}>
                <button onClick={onClose} style={{ flex: 1, padding: "12px", border: "1.5px solid #E5E7EB", borderRadius: 10, background: "#fff", color: "#374151", fontWeight: 600, fontSize: 14, cursor: "pointer" }}>
                  Cancelar
                </button>
                <button
                  onClick={() => { if (novaData && novoHorario && motivo) setStep(2); }}
                  style={{ flex: 2, padding: "12px", border: "none", borderRadius: 10, background: novaData && novoHorario && motivo ? "#7C3AED" : "#D1D5DB", color: "#fff", fontWeight: 600, fontSize: 14, cursor: novaData && novoHorario && motivo ? "pointer" : "not-allowed" }}
                >
                  Enviar solicitação
                </button>
              </div>
          ...
          <>
            ...
            <div style={{ padding: 20 }}>
              <div style={{ background: "#FFFBEB", border: "1px solid #FDE68A", borderRadius: 10, padding: "12px 14px", display: "flex", gap: 10, marginBottom: 20 }}>
                <IconAlert />
                <div>
                  <div style={{ fontWeight: 600, fontSize: 14, color: "#92400E" }}>O prestador irá analisar sua solicitação</div>
                  <div style={{ fontSize: 13, color: "#92400E", marginTop: 2 }}>Aguardamos a resposta do prestador.</div>
                </div>
              </div>
              ...
              {[
                ...
                { label: "Prestador", value: "João Silva" },
              ...
              <div style={{ display: "flex", gap: 12, marginTop: 24 }}>
                <button onClick={() => setStep(1)} style={{ flex: 1, padding: "12px", border: "1.5px solid #E5E7EB", borderRadius: 10, background: "#fff", color: "#374151", fontWeight: 600, fontSize: 14, cursor: "pointer" }}>
                  Voltar
                </button>
                <button onClick={() => setStep(3)} style={{ flex: 2, padding: "12px", border: "none", borderRadius: 10, background: "#7C3AED", color: "#fff", fontWeight: 600, fontSize: 14, cursor: "pointer" }}>
                  Confirmar e enviar
                </button>
              </div>
            </div>
          ...
          <>
            ...
            <div style={{ padding: 32, textAlign: "center" }}>
              ...
              <p style={{ fontSize: 14, color: "#6B7280", marginBottom: 20 }}>
                O prestador foi notificado e irá analisar sua proposta de reagendamento.
              </p>

              <div style={{ background: "#FEF3C7", border: "1px solid #FDE68A", borderRadius: 10, padding: "12px 16px", marginBottom: 24, textAlign: "left" }}>
                <div style={{ fontSize: 12, color: "#9CA3AF", marginBottom: 4 }}>Nova proposta</div>
              ...
              <div style={{ background: "#F5F3FF", borderRadius: 8, padding: "10px 12px", fontSize: 13, color: "#7C3AED", marginBottom: 24, display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
                <IconBell /> Você será notificado quando o prestador responder.
              </div>

              <button
                onClick={() => { onConcluir && onConcluir(); onClose(); }}
                style={{ width: "100%", padding: "12px", border: "none", borderRadius: 10, background: "#7C3AED", color: "#fff", fontWeight: 600, fontSize: 14, cursor: "pointer" }}
              >
                Fechar
              </button>
            </div>
