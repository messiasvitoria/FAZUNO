...
function saveClientRequest(service, schedule) {
  ...
  window.sessionStorage.setItem(CLIENT_REQUESTS_KEY, JSON.stringify([request, ...withoutSameRequest]));
...
function savePublishedOpportunity(form) {
  ...
  window.sessionStorage.setItem(CLIENT_REQUESTS_KEY, JSON.stringify([opportunity, ...withoutPreviousOpportunity]));
