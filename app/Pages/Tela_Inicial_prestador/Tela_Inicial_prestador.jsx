...
export default function Tela_inicio_prestador() {
  ...
  // Notificações reais do prestador, vindas do localStorage via
  // lib/notifications.js. Atualizam sozinhas quando o cliente cancela
  // uma solicitação em outra tela/aba (addNotification dispara o evento).
  const notifications = useNotifications("prestador");
