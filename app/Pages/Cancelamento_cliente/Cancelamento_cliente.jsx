...
const STEPS_INFO = [
  {
    ...
    desc: "Cliente acessa os detalhes da solicitação.",
  },
  {
    id: 2,
    title: "Solicitar cancelamento",
    desc: "Cliente escolhe o motivo do cancelamento.",
  },
  {
    id: 3,
    title: "Confirmar cancelamento",
    desc: "Cliente revisa as informações e confirma.",
  },
  {
    id: 4,
    title: "Cancelamento realizado",
    desc: "Sistema registra e notifica o prestador.",
  },
  {
    id: 5,
...
export default function CancelamentoCliente() {
  ...
  // Confirma o cancelamento E dispara a notificação para o PRESTADOR
  const confirmarCancelamento = () => {
    addNotification({
      audience: "prestador", // quem recebe a notificação é o prestador
      type: "cancelamento",
    ...
    <Card>
      ...
      >
        ...
        <div>
          ...
          >
            <FaStar size={11} color={C.star} /> {REQUEST.prestador.rating} (
            {REQUEST.prestador.avaliacoes} avaliações)
          </div>
        </div>
      </div>
    ...
    <Card>
      ...
      >
        ...
        <span style={{ fontSize: 13.5, color: C.navy }}>
          Ao confirmar, sua solicitação será cancelada e o prestador será
          notificado.
        </span>
      </div>
  ...
  return (
    <Card style={{ textAlign: "center" }}>
      ...
      >
        ...
        <SummaryLine
          label="Cancelado por"
          value={`${REQUEST.cliente.nome} (Cliente)`}
        />
