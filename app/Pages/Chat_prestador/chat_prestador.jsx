...
const conversations = [
  ...
  { id: 2, name: "Ricardo Alves", service: "Pintura residencial", time: "Ontem", preview: "Obrigado pelo serviço!", unread: 0, online: false, avatar: "https://i.pravatar.cc/150?img=11" },
  { id: 3, name: "Juliana Lima", service: "Reforma de banheiro", time: "2 dias", preview: "Pode me enviar o orçamento?", unread: 1, online: false, avatar: "https://i.pravatar.cc/150?img=33" },
  { id: 4, name: "Carlos Oliveira", service: "Manutenção hidráulica", time: "3 dias", preview: "Aguardando sua disponibilidade.", unread: 0, online: false, avatar: "https://i.pravatar.cc/150?img=52" },
  { id: 5, name: "Equipe FazUno", service: "Suporte", time: "5 dias", preview: "Sua solicitação foi atualizada.", unread: 0, online: false, avatar: null, avatarColor: "#7C3AED", avatarLetter: "F" },
];
    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Inter', sans-serif", background: "#F9FAFB", color: "#111827" }}>
      ...
      <aside style={{ width: 280, borderRight: "1px solid #E5E7EB", background: "#fff", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", gap: 6, padding: "0 16px 12px" }}>
          {["Todas", "Não lidas", "Contratações"].map((t) => (
            <button key={t} onClick={() => setTab(t)} style={{ padding: "6px 10px", borderRadius: 20, border: "none", cursor: "pointer", fontSize: 12, fontWeight: 500, background: tab === t ? "#7C3AED" : "#F3F4F6", color: tab === t ? "#fff" : "#6B7280", display: "flex", alignItems: "center", gap: 4 }}>
              {t}
              {t === "Não lidas" && <span style={{ background: tab === t ? "rgba(255,255,255,0.3)" : "#7C3AED", color: "#fff", borderRadius: 10, padding: "1px 5px", fontSize: 10 }}>3</span>}
            </button>
          ))}
        </div>
        ...
        <div style={{ padding: 16, borderTop: "1px solid #E5E7EB", textAlign: "center" }}>
          ...
          <button style={{ width: "100%", padding: "10px", border: "1.5px solid #7C3AED", borderRadius: 8, background: "none", color: "#7C3AED", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>Ver todas as conversas</button>
        </div>
      </aside>
      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", background: "#fff" }}>
        ...
        <div style={{ padding: "12px 20px", borderBottom: "1px solid #E5E7EB", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 13, color: "#6B7280" }}>Cliente • desde Mai/2025</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 13, color: "#6B7280" }}>
                Código: #CON-4587{" "}
                <span style={{ background: "#FEF3C7", color: "#D97706", borderRadius: 12, padding: "2px 8px", marginLeft: 6, fontWeight: 600, fontSize: 12 }}>Em andamento</span>
              </div>
            </div>
          </div>
        ...
        <div style={{ padding: "0 20px 12px", display: "flex", gap: 8 }}>
          {[{ icon: "📅", label: "Agendar visita" }, { icon: "💲", label: "Enviar orçamento" }, { icon: "📎", label: "Enviar arquivo" }, { icon: "💬", label: "Mensagens rápidas" }].map((a) => (
