...
const conversations = [
  ...
  { id: 5, name: "Equipe FazUno", service: "Suporte", time: "5 dias", preview: "Sua solicitação foi atualizada.", unread: 0, online: false, avatar: null, avatarColor: "#0A0B2D", avatarLetter: "F" },
];
    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Inter', sans-serif", background: "#F9FAFB", color: "#111827" }}>
      ...
      <aside style={{ width: 280, borderRight: "1px solid #E5E7EB", background: "#fff", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", gap: 6, padding: "0 16px 12px" }}>
          {["Todas", "Não lidas", "Contratações"].map((t) => (
            <button key={t} onClick={() => setTab(t)} style={{ padding: "6px 10px", borderRadius: 20, border: "none", cursor: "pointer", fontSize: 12, fontWeight: 500, background: tab === t ? "#0A0B2D" : "#F3F4F6", color: tab === t ? "#fff" : "#6B7280", display: "flex", alignItems: "center", gap: 4 }}>
              {t}
              {t === "Não lidas" && <span style={{ background: tab === t ? "rgba(255,255,255,0.3)" : "#0A0B2D", color: "#fff", borderRadius: 10, padding: "1px 5px", fontSize: 10 }}>3</span>}
            </button>
          ))}
        </div>
        ...
        <div style={{ padding: 16, borderTop: "1px solid #E5E7EB", textAlign: "center" }}>
          ...
          <button style={{ width: "100%", padding: "10px", border: "1.5px solid #0A0B2D", borderRadius: 8, background: "none", color: "#0A0B2D", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>Ver todas as conversas</button>
        </div>
      </aside>
