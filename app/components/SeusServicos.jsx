  ...
  return (
    <div style={{ background: "#fff", borderRadius: 12, border: "0.5px solid rgba(0,0,0,0.10)", padding: "20px 24px", flex: 1, minWidth: 0 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        ...
        <button
          onClick={() => router.push("/Pages/Tela_CadastroServico_Prestador")}  // ← onClick adicionado
          style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 600, color: "#fff", background: "#1e293b", border: "none", borderRadius: 8, padding: "8px 14px", cursor: "pointer" }}
        >
