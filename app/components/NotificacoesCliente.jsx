...
import { FaFileAlt, FaCommentAlt, FaCreditCard, FaStar, FaBriefcase } from "react-icons/fa";

const categorias = ["Todas", "Não lidas", "Solicitações", "Serviços", "Pagamentos"];

const notificacoes = [
  {
    id: 1,
    titulo: "Serviço Aceito",
    descricao: "O prestador João Silva aceitou sua solicitação de Instalação de Ar Condicionado.",
    link: "Ver detalhes",
    tempo: "Há 5 min",
    lida: false,
  ...
  },
  {
    ...
    descricao: "Você recebeu uma nova mensagem do prestador João Silva.",
    link: "Ver conversa",
    tempo: "Há 20 min",
    lida: false,
    categoria: "Solicitações",
  ...
  },
  {
    ...
    descricao: "Seu pagamento de R$ 350,00 foi aprovado com sucesso.",
  ...
  {
    id: 4,
    titulo: "Avalie seu Serviço",
    descricao: "Seu serviço de Limpeza Residencial foi concluído. Conte como foi sua experiência!",
    link: "Avaliar agora",
    tempo: "Ontem às 10:30",
    lida: true,
    categoria: "Serviços",
    icon: FaStar,
    iconBg: "#fef3c7",
  ...
  {
    id: 5,
    titulo: "Prestador Visualizou sua Solicitação",
    descricao: "O prestador Maria Santos visualizou sua solicitação de Pintura Residencial.",
...
export default function NotificacoesCliente({ onClose }) {
