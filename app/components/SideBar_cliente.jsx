...
export default function Sidebar({ activeNav, setActiveNav }) {
  ...
  return (
    <div style={{ width: 180, minWidth: 180, alignSelf: "stretch", backgroundColor: "#0d1b3e", display: "flex", flexDirection: "column", flexShrink: 0, zIndex: 30, boxShadow: "4px 0 24px rgba(0,0,0,0.25)" }}>
